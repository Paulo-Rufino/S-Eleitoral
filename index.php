...
<div class="login-box">
  	<div class="login-logo">
  		<b>SISTEMA ELEITORAL</b>
  	</div>
  
  	<div class="login-box-body">
    	<p class="login-box-msg"><b>Faça login para iniciar sua sessão</b></p>

    	<form action="login.php" method="POST">
      		<div class="form-group has-feedback">
        		<input type="text" class="form-control" name="voter" placeholder="Usuário" required>
